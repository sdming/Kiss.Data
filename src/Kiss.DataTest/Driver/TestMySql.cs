...
";
        ...
        public void TestSchema()
        {
            ...
            Assert.True(cbool.DbType == DbType.SByte, "cbool.DbType");
            ...
            Assert.True(cfloat.DbType == DbType.Single, "cfloat.DbType");
            //Assert.True(cfloat.RuntimeType == typeof(double), "cfloat.RuntimeType");
            //Assert.True(cfloat.RuntimeType == typeof(Single), "cfloat.RuntimeType");
            ...
            Assert.True(cguid.DbType == DbType.String, "cguid.DbType");
            //Assert.True(cguid.RuntimeType == typeof(String), "cguid.RuntimeType");
