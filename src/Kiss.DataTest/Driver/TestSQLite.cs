...
namespace Kiss.DataTest.Driver
{
    ...
    {
        private const string dbName = "sqlite";
...
";
        ...
        public void TestSchema()
        {
            ...
            Assert.True(cint.DbType == DbType.Int32 || cint.DbType == DbType.Int64, "cint.DbType");
            //Assert.True(cint.RuntimeType == typeof(int)|| cint.RuntimeType == typeof(Int64), "cint.RuntimeType");
