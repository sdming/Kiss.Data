...
namespace Kiss.Data.Driver
{
    ...
    /// OracleManagedDriver
    /// </summary>
    public class OracleManagedDriver : SqlDriver
    {
        /// <summary>
        /// ProviderName
        /// </summary>
        ...
        public override DbParameter CreateParameter(string name, object value)
        {
            if (value is bool)
            {
                return new OracleParameter(name, Convert.ToInt32(value));
            } 
            else if (value is Guid)
            {
                return new OracleParameter(name, ((Guid)value).ToByteArray() );
            }
        ...
        {
            return new OracleManagedSchema();
        }
